...
/* harmony import */ var _modules_about_company__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/about-company */ "./js/modules/about-company.js");
...
var siteSectionsButton = document.querySelector('.button--site-sections');
var ourOfficeButton = document.querySelector('.button--our-office');
var siteSettingList = document.querySelector('.footer-list--site-sections');
var ourOfficeList = document.querySelector('.footer-list--our-office');
var inputMask = document.querySelector('.form__input--phone');
var modalInputMask = document.querySelector('.form__input--phone-modal');
var maskOptions = {
  mask: '+{7}(000)000-00-00'
};
window.addEventListener('DOMContentLoaded', function () {
  var mask = new imask__WEBPACK_IMPORTED_MODULE_3__["default"](inputMask, maskOptions);
  var modalMask = new imask__WEBPACK_IMPORTED_MODULE_3__["default"](modalInputMask, maskOptions);
  var maskTel = function maskTel() {
    return mask;
  };
  var modalMaskTel = function modalMaskTel() {
    return modalMask;
  };
  ...
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_1__["switchAccordion"])();
  Object(_modules_about_company__WEBPACK_IMPORTED_MODULE_2__["hideParagraphs"])();
  maskTel();
  modalMaskTel();
  scrollSmooth();
...
/***/ "./js/modules/about-company.js":
/*!*************************************!*\
  !*** ./js/modules/about-company.js ***!
  \*************************************/
/*! exports provided: hideParagraphs */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hideParagraphs", function() { return hideParagraphs; });
var hiddenParagraphs = document.querySelectorAll('.about-company__description--hidden');
var buttonAboutCompany = document.querySelector('.about-company__button');
var buttonTextClose = document.querySelector('.button__text--close');
var buttonTextOpen = document.querySelector('.button__text--open');
var hideParagraphs = function hideParagraphs() {
  buttonAboutCompany.addEventListener('click', function () {
    if (buttonTextClose.classList.contains('hidden')) {
      ...
      hiddenParagraphs.forEach(function (element) {
...
/*!*********************************!*\
  !*** ./js/modules/accordion.js ***!
  \*********************************/
/*! exports provided: switchAccordion */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "switchAccordion", function() { return switchAccordion; });
var siteSectionsButton = document.querySelector('.button--site-sections');
var ourOfficeButton = document.querySelector('.button--our-office');
var siteSettingList = document.querySelector('.footer-list--site-sections');
var ourOfficeList = document.querySelector('.footer-list--our-office');
var switchAccordion = function switchAccordion() {
...
var Modals = /*#__PURE__*/function () {
  ...
  _createClass(Modals, [{
    ...
    value: function open() {
      ...
      setTimeout(function () {
        _this._focusLock.lock('.form__group--modal', _this._startFocus);
